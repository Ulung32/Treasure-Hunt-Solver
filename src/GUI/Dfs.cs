...
namespace Dfs
{
    ...
    public class Dfs
    {
        ...
        public Dfs(Matrix m, bool tsp)
        {
            ...
            searchTreasure(ref i, ref j, ref treasureCount, ref m, ref path, ref searchPathStack);
            if (tsp)
            {
                searchWayBack(ref i, ref j, ref treasureCount, ref m, ref path, ref searchPathStack);
            }
        ...
        private void searchTreasure(ref int i, ref int j, ref int treasureCount, ref Matrix m, ref Stack<Tuple<int, int>> path, ref Stack<Tuple<int, int>> searchPathStack)
        {
            Tuple<int, int> temp;
        ...
        private void searchWayBack(ref int i, ref int j, ref int treasureCount, ref Matrix m, ref Stack<Tuple<int, int>> path, ref Stack<Tuple<int, int>> searchPathStack)
        {
